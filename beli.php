    <?php 
        ...
        $qry_detail_produk=mysqli_query($conn,"select *
        from produk where id_produk = '".$_GET['id_produk']."'");
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <img src="foto/<?=$dt_produk['foto_produk']?>"
            class="card-img-top">
        ...
        <div class="col-md-8">
            ...
            <form action="masukkankeranjang.php?id_produk=<?=$dt_produk
            ['id_produk']?>"
            method="post">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>Nama Produk</td><td><?=$dt_produk
                            ['nama_produk']?></td>
